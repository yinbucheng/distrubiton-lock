...
public abstract class CuratorUtils {
     ...
     * @param path
     */
    public static ListenerDefination   addListener(CuratorFramework client,String path,final NodeEvent nodeEvent){
        try {
            ...
            return new ListenerDefination(cache,listener);
        }catch (Exception e){
            throw new RuntimeException(e);
        }
    }
    ...
    /**
     * 取消时间监听
     * @param listenerDefination
     */
    public static void removeListener(ListenerDefination listenerDefination) {
        listenerDefination.cache.getListenable().removeListener(listenerDefination.listener);
    }
    ...
    public static class ListenerDefination{
        private PathChildrenCache cache;
        private PathChildrenCacheListener listener;

        public ListenerDefination(PathChildrenCache cache, PathChildrenCacheListener listener) {
            this.cache = cache;
        ...
        public void setListener(PathChildrenCacheListener listener) {
            this.listener = listener;
        }
    }
